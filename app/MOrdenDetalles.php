...
class MOrdenDetalles extends Model
{
    ...
    protected $fillable = [
        ...
        'dato47', //Vertical
        'dato48', //Puente
        'dato49', //Diagonal "en pdf le dicen Diametro"
        ...
        'nro_fact', //Numero Factura
        'obs_lab', //Null
        'curva_base', //Null
        'nota_credito', //Null
        'nota_credito_texto', //Null
        'nota_credito4', //Null
        'nota_credito2', //Null
        'nota_credito3', //Null
    ];
    ...
    function usuario(){            
        // Especificamos que una orden pertenece a un usuario.
        return $this->belongsTo(User::class);  
    }

    function cliente(){            
        // Especificamos que una orden pertenece a un cliente.
        return $this->belongsTo(MClientes::class);  
    }
