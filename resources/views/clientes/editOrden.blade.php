   ...
   <div class="content">
       <div class="row">
           <div class="col-md-12 text-center">
               <form class="col-md-12" action="{{ route('ordenes.update', $orden) }}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="card">                      
                       <div class="card-header">
                           <h5 class="title">{{ __('Editar Orden') }}</h5>                                                         
                       </div>
                       <div class="card-body">
                                       ...
                                       <tbody>
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrmonturav" name="vrmonturav" class="form-control bg-secondary" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrmonturav')" formnovalidate placeholder="" value={{$orden->dato34}}
                                                   @if (auth()->user()->rol !="adminisis" && auth()->user()->rol !="semiadministrador" ) readonly @endif>                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrlentev" name="vrlentev" class="form-control bg-secondary"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrlentev')" formnovalidate placeholder="" value={{$orden->dato35}} 
                                                   @if (auth()->user()->rol !="adminisis" && auth()->user()->rol !="semiadministrador" ) readonly @endif>                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="text" id="totalv" name="totalv" class="form-control bg-secondary" placeholder="" value={{$orden->dato36}} readonly >                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="abonoinicialv" name="abonoinicialv" class="form-control bg-secondary" onchange="addCommas('abonoinicialv')"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" formnovalidate placeholder="" 
                                                   @if (auth()->user()->rol !="adminisis" && auth()->user()->rol !="semiadministrador" ) readonly @endif  value={{$orden->dato37}}>                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="text" id="saldov" name="saldov" class="form-control bg-secondary" placeholder="" value={{$orden->dato38}} readonly >                                                   
                                               </div>
