...
<body onload="anchoTablaf()" class="" style="">
   ...
   {{-- -----------------------------Desde aqui empieza------------------------------- --}}
                <div >
                    <table id="tabla1" style="text-align: center; width: 100.5%">
                        <thead>
                            <tr>
                                <td>
                                    <div class="" style="">
                ...
                <div style="font-size: 11px; color: #18226A">
                    <table id="tabla2" class="bordes" style="width: 100.5%" >
                        <tbody style="">
                            <tr>
                ...
                <div style="font-size: 11px; color: #18226A; padding-top: 2px">
                    <table id="tabla3" class="bordes" style="width: 100.5%" >
                        <tbody style="">
                            <tr>
                ...
                <div style="font-size: 11px; color: #18226A">
                    <table id="tabla4" class="bordes" style="width: 100.5%">
                        <tbody style="">
                            <tr>
                ...
                <div style="font-size: 11px; color: #18226A;">
                    <table id="tabla5" class="bordes" style="max-width: 100%">
                        <tbody style="">
                            <tr>
                            ...
                            <tr style="">
                                ...
                                <td colspan="6" >{{$orden->obs_lab}}</td>
                            </tr>
                            <tr style="">
                                <td class="titulo ancho">{{__('Montura')}}</td>
                                <td class="ancho2" colspan="2">{{$montura}}</td>
                                <td class="titulo ancho">{{__('Nueva')}}</td>
                                <td class="ancho2">{{$nueva}}</td>
                                <td class="titulo ancho">{{__('Usada')}}</td>
                                <td class="ancho2">{{$usada}}</td>
                                <td class="titulo ancho">{{__('Referencia')}}</td>
                                <td class="ancho2">{{$ref}}</td>
                            </tr>
                            <tr style="">
                                <td class="titulo ancho" colspan="3">{{__('Estado')}}</td>
                                <td class="titulo ancho">{{__('Rayada')}}</td>
                                <td class="ancho2">{{$rayada}}</td>
                                <td class="titulo ancho">{{__('Pelada')}}</td>
                                <td class="ancho2">{{$pelada}}</td>
                                <td class="titulo ancho">{{__('Otro')}}</td>
                                <td class="ancho2">{{$otro}}</td>
                            </tr>
                            <tr style="">
                    ...
                    <img id="imgplaneta" src="{{ asset("img/facturas/logo_amigos_planeta.png") }}" class="superponer2" style="max-height: 105px"/>
                </div>            
                    <script>
