...
<body onload="anchoTablaf()" class="" style="">
   ...
   {{-- -----------------------------Desde aqui empieza------------------------------- --}}
    {{-- <div style="width: 100%; height: 100%; background:#525659; display: grid">
        ...
        <div id="divImprimir">
            ...
            <div style=" width: 100%; height: 100%; text-align: center">    
                <div style= "text-aling: center; padding-left: 2.5rem">
                ...
                <div style="font-size: 11px; color: #404040; width:100%">
                    <table id="tabla2" class="bordes3" style="width:100% ">
                        <tbody style="">
                            <tr>
