...
<body onload="anchoTablaf()" class="" style="">
   ...
   {{-- -----------------------------Desde aqui empieza------------------------------- --}}
    <div style="width: 100%; height:display: grid; font-family: Arial">
        ...
        <div id="divImprimir">                    
            <div style="width: 50rem; height: 60rem; margin-left: auto; margin-right: auto; margin-bottom: 1%; background: white; padding: 80px; border: 2px solid #f5f5f5; border: 0px">
                <div style="text-align: -webkit-center;">
                    <table id="tabla10" style="text-align: center">
                        <thead>
                            <tr>
                                <td>
                                    <div class="" style="">
                ...
                <div id="Nombre1 debe ser arial tamaño 11">
                    ...
                    <div id="imgfirma" style="position: absolute; top: 970px">
