   ...
   <div class="content">
       <div class="row">
           <div class="col-md-12 text-center">
                <form class="col-md-12" action="{{ route('garantias.update', $garantia)}}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="card">                      
                       <div class="card-header">
                        ...
                        @endphp
                           <h5 class="title">{{ __('Editar Garantía No.') }} <label>{{ $nroGarantia }}</label></h5>                                                         
                       </div>
                       <div class="card-body">
                   ...
                   <div class="card ">
                       ...
                       <div class="card-body">  
                                       ...
                                       <tbody>
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrmonturav" name="vrmonturav" class="form-control bg-secondary" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrmonturav')" formnovalidate placeholder="" readonly value={{$garantia->dato34}}>                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrlentev" name="vrlentev" class="form-control bg-secondary"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrlentev')" formnovalidate placeholder="" readonly value={{$garantia->dato35}} >                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="abonoinicialv" name="abonoinicialv" class="form-control bg-secondary" onchange="addCommas('abonoinicialv')"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" formnovalidate placeholder="" readonly value={{$garantia->dato37}}>                                                   
                                               </div>
                           ...
                           <div class="row" style="display: contents">
                            <label class="w-75" ><b>{{ __('Estado de La Garantía') }}</b></label>
                       ...
                       <div class="card-footer ">
                           <div class="row">
                               <div class="col-md-12 text-center">
                                   <button type="submit" class="btn btn-info btn-round">{{ __('Actualizar Garantía') }}</button>
                               </div>
                           </div>
                       </div>
                   </div>
