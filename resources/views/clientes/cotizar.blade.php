   ...
   <div class="content">
       <div class="row">
           <div class="col-md-12 text-center">
               <form class="col-md-12" action="{{ route('cotizaciones.store') }}" method="POST" enctype="multipart/form-data">
                   <input type="hidden" name="_method" value="PUT">
                   <input type="hidden" name="_token" value="{{ csrf_token() }}">
                   <input type="hidden" name="usuarioActivo" value="{{ auth()->user()->nombre }}">
                   <input type="hidden" name="estadoCotizacion" value="COTIZACION">
                   <input type="hidden" name="idCliente" value="{{$cliente->id}}">
                   <div class="card">                      
                       <div class="card-header">
                           <h5 class="title">{{ __('Nueva Cotización') }}</h5>                                                         
                       </div>
                       <div class="card-body">
                           <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">                                
                               ...
                               <div class="col-6 col-md-2 align-middle pl-1" style="font-size: 0.85em">
                                   ...
                                   <br><input style="width: 90%" type="date" name="fechaEntrega" > 
                                   <br><label class="pt-1"><b>{{ __('Hora Entrega') }}</b></label>
                                   <br><input id="appt-time" type="time" name="horaEntrega" value="12:00">                       
                               </div>                            
                       ...
                       <div class="card-footer ">
                        <div class="row justify-content-center">
                            <div class="col" style="text-align: -webkit-center">
                                ...
                                <input type="text" name="dirigido" class="form-control" style="width: auto" placeholder="" value="" >    
                            </div>
                        </div>  
                       </div>
                   </div>                    
                                         ...
                                         <tr>
                                           <th scope="row" class="table-secondary alinear" >
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id='esfera' name="esfera"  class="form-control" placeholder="" value="" >    
                                               </div>
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light alinear">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="esferai" name="esferai"  class="form-control" placeholder="" value="" >    
                                               </div> 
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary alinear ">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="cilindro" name="cilindro"  class="form-control" placeholder="" value="" >    
                                               </div>  
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light alinear">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="cilindroi" name="cilindroi"  class="form-control" placeholder="" value="" >    
                                               </div>  
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="eje"  class="form-control" placeholder="" value="" >    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="ejei"  class="form-control" placeholder="" value="" >    
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                               ...
                               <div class="col-xl-1 col-md-2 col-sm-2 col-6 bordes" > <!-- D.N.P-->
                                   <table class="table table-bordered altoFila"  >
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="dnp" class="form-control" placeholder="" value="" >    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="dnpi" class="form-control" placeholder="" value="" >    
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-light altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="tipol" name="tipol"  class="form-control" placeholder="" value="" >    
                                               </div>
                                           </th>                                            
                                         </tr>  
                                         <tr>
                                           <th scope="row" class="table-secondary altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="tratamientol" name="tratamientol"  class="form-control" placeholder="" value="" >    
                                               </div>
                                           </th>
                                         </tr>                                         
                                       </tbody>
                                       ...
                                       <tbody>
                                         ...
                                         <tr>
                                           <th scope="row" class="table-secondary altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="materiall" name="materiall"  class="form-control" placeholder="" value="" >    
                                               </div>
                                           </th> 
                                         </tr>                                         
                                       </tbody>
                   ...
                   <div class="card ">
                       ...
                       <div class="card-footer ">
                           <div class="row">
                               <div class="col-md-12 text-center">
                                   <button type="submit" class="btn btn-info btn-round">{{ __('Crear Cotización') }}</button>
                               </div>
                           </div>
                       </div>
                   </div>
