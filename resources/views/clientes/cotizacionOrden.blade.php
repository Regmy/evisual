   ...
   <div class="content">
       <div class="row">
           <div class="col-md-12 text-center">
                <form class="col-md-12" action="{{ route('cotizaciones.convertir', $cotizacion)}}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="card">                      
                       <div class="card-header">
                        ...
                        @endphp
                           <h5 class="title">{{ __('Convertir Cotización No.') }} <label>{{ $nroCotizacion }}</label> {{ __(' a Orden') }}</h5>                                                         
                       </div>
                       <div class="card-body">
                   ...
                   <div class="card ">
                       ...
                       <div class="card-body">  
                                       ...
                                       <tbody>
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrmonturav" name="vrmonturav" class="form-control bg-secondary" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrmonturav')" formnovalidate placeholder="" readonly value={{$cotizacion->dato34}} >                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrlentev" name="vrlentev" class="form-control bg-secondary"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrlentev')" formnovalidate placeholder="" readonly value={{$cotizacion->dato35}} >                                                   
                                               </div>
                           ...
                           <div class="row" style="display: inline-flex">
                            ...
                            <label class="pl-2" style="color: limegreen" ><b>{{('CUARENTENA') }}</b></label>
                            <input type="hidden" name="estadoCotizacion" value='CUARENTENA'>
                            <!--div class="col-12 px-1 px-md-5" style="max-height: 8rem">
                                <div class="form-check form-check-inline">
                                    ...
                                    @if($cotizacion->dato59 == 'CUARENTENA') checked @endif>
                                  ...
                                  <div class="form-check form-check-inline">
                                    ...
                                    @if($cotizacion->dato59 == 'SEPARADO') checked @endif>
                                  ...
                                  <div class="form-check form-check-inline">
                                    ...
                                    @if($cotizacion->dato59 == 'PEDIDO_LABORATORIO') checked @endif>
                                  ...
                                  <div class="form-check form-check-inline">
                                    ...
                                    @if($cotizacion->dato59 == 'CORTE Y DISENO') checked @endif>
                                  ...
                                  <div class="form-check form-check-inline">
                                    ...
                                    @if($cotizacion->dato59 == 'PRODUCTO TERMINADO') checked @endif>
                                  ...
                                  <div class="form-check form-check-inline">
                                    ...
                                    @if($cotizacion->dato59 == 'TRABAJO ENTREGA') checked @endif>
                       ...
                       <div class="card-footer ">
                           <div class="row">
                               <div class="col-md-12 text-center">
                                   <button type="submit" class="btn btn-info btn-round">{{ __('Convertir a Orden') }}</button>
                               </div>
                           </div>
                       </div>
                   </div>
