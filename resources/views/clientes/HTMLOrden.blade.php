                    ...
                    <table id="tabla1" style="">
                        <thead>
                            <tr>
                                ...
                                <td>
                                    <div class="" style="">
                                        <img src="{{ asset("img/facturas/$facturaRango->imagen_datos") }}"  style="max-height: 120px;  max-width:210px; "/>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="" style="">
                                        <img src="{{ asset("img/facturas/logo_EV.png") }}"  style="max-height: 120px;  max-width:210px; text-align: right"/>
                                    </div>
                                </td>
                            </tr>
                        </thead>
