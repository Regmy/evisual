   ...
   <div class="content">
       <div class="row">
           <div class="col-md-12 text-center">
               <form class="col-md-12" action="{{ route('ordenes.updatelab', $orden) }}" method="POST" enctype="multipart/form-data">
                   <input type="hidden" name="_method" value="PUT">
                   <input type="hidden" name="_token" value="{{ csrf_token() }}">
                   <input type="hidden" name="idSO" value="{{$servioptica->id}}">

                   <div class="card">                      
                       <div class="card-header">
                           <h5 class="title">{{ __('Laboratorio') }}</h5>                                                         
                       </div>
                       <div class="card-body">
                           <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">                                
                               <div class="col-6 col-md-2 align-middle pl-1  " style="font-size: 1em" >
                                   ...
                                   <br>{{ $orden->fecha }}
                                   <br><label class="pt-2"><b>{{ __('Asesor:') }}</b> <b class="text-dark">{{ $orden->dato58 }}</b></label>
                               </div>                                
                               <div class="col-6 col-md-2 align-middle pl-1" style="font-size: 0.85em">
                                   <label class=""><b>{{ __('Fecha Entrega') }} </b></label>
                                   <br><input style="width: 90%" type="date" name="fechaEntrega" value="<?php echo $orden->dato0; ?>"> 
                                   <br><label class="pt-1"><b>{{ __('Hora Entrega') }}</b></label>
                                   <br><input id="appt-time" type="time" name="horaEntrega" value={{$orden->dato1}}>                       
                               </div>                            
                               <div class="col col-md-8 align-middle pl-1" >
                                   ...
                                   <table class="table table-sm table-responsive-md" style="font-size: 0.75em">
                                       <tr><td ><label class="" ><b style="font-size: 1.2em">{{ __('Nombre:') }}</b></label></td><td colspan='2'>{{ __('---') }}</td>
                                           <td ><label class="" ><b style="font-size: 1.2em">{{ __('Documento:') }}</td><td>{{ __('---') }}</td></tr>
                                       <tr><td ><label class="" ><b style="font-size: 1.2em">{{ __('Celular:') }}</td><td>{{ __('---') }}</td>
                                           <td ><label class="" ><b style="font-size: 1.2em">{{ __('Teléfono:') }}</td><td>{{ __('---') }}</td>
                                           <td ><label class="" ><b style="font-size: 1.2em">{{ __('Correo:') }}</td><td>{{ __('---') }}</td></tr>
                                   </table>
                               </div>
                           </div>
                       </div>
                                         ...
                                         <tr>
                                           <th scope="row" class="table-secondary alinear" >
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id='esfera' name="esfera"  class="form-control" placeholder="" value={{$orden->dato2}}>    
                                               </div>
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light alinear">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="esferai" name="esferai"  class="form-control" placeholder="" value={{$orden->dato14}} >    
                                               </div> 
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary alinear ">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="cilindro" name="cilindro"  class="form-control" placeholder="" value={{$orden->dato3}} >    
                                               </div>  
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light alinear">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="cilindroi" name="cilindroi"  class="form-control" placeholder="" value={{$orden->dato15}} >    
                                               </div>  
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="eje"  class="form-control" placeholder="" value={{$orden->dato4}} >    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="ejei"  class="form-control" placeholder="" value={{$orden->dato16}} >    
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                                           ...
                                           <th scope="row" class="table-secondary  ">
                                               <div class="form-group" >
                                                   <select class="form-control" id="adicion" type="text" name="adicion" placeholder="--" value=""  >
                                                    <option value={{$orden->dato5}}>{{$orden->dato5}}</option>
                                                    <option value="">{{__('--')}}</option>
                                           ...
                                           <th scope="row" class="table-light ">
                                               <div class="form-group " >
                                                   <select class="form-control" id="adicioni" type="text" name="adicioni" placeholder="--" value=""  >
                                                    <option value={{$orden->dato17}}>{{$orden->dato17}}</option>
                                                    <option value="">{{__('--')}}</option>
                                                       @foreach ($adicion as $parametro)
                                                           <option value="{{$parametro['option_value']}}">{{$parametro['option_value']}}</option>                                                    
                                                       @endforeach                                               
                               ...
                               <div class="col-xl-1 col-md-2 col-sm-2 col-6 bordes" > <!-- D.N.P-->
                                   <table class="table table-bordered altoFila"  >
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="dnp" class="form-control" placeholder="" value={{$orden->dato6}}>
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="dnpi" class="form-control" placeholder="" value={{$orden->dato18}}>
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                               ...
                               <div class="col-xl-1 col-md-2 col-sm-2 col-6 bordes" > <!-- Altura-->
                                   <table class="table table-bordered altoFila" >
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="altura" class="form-control" placeholder="" value={{$orden->dato7}} >    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="alturai" class="form-control" placeholder="" value={{$orden->dato19}}>
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                               ...
                               <div class="col-xl-2 col-md-2 col-sm-2 col-6 bordes" > <!-- Prisma-->
                                   <table class="table table-bordered altoFila" >
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="prisma"  class="form-control" placeholder="" value={{$orden->dato8}}>    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="prismai" class="form-control" placeholder="" value={{$orden->dato20}}>    
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                                           ...
                                           <th scope="row" class="table-secondary ">
                                               <div class="form-group">
                                                   <select class="form-control p-1" id="lente" type="text" name="lente" placeholder="--" value=""  >
                                                    <option value={{$orden->dato9}}>{{$orden->dato9}}</option>
                                                    <option value="">{{__('--')}}</option>
                                           ...
                                           <th scope="row" class="table-light">
                                               <div class="form-group">
                                                   <select class="form-control p-1" id="lentei" type="text" name="lentei" placeholder="--" value=""  >
                                                    <option value={{$orden->dato21}}>{{$orden->dato21}}</option>
                                                    <option value="">{{__('--')}}</option>
                                                       @foreach ($lente as $parametro)
                                                           <option value="{{$parametro['option_value']}}">{{$parametro['option_value']}}</option>                                                    
                                                       @endforeach                                               
                                           ...
                                           <th scope="row" class="table-secondary ">
                                               <div class="form-group">
                                                   <select class="form-control" id="lab" type="text" name="lab" placeholder="--" value=""  >
                                                    <option value={{$orden->dato10}}>{{$orden->dato10}}</option>
                                                    <option value="">{{__('--')}}</option>
                                           ...
                                           <th scope="row" class="table-light">
                                               <div class="form-group">
                                                   <select class="form-control" id="labi" type="text" name="labi" placeholder="--" value=""  >
                                                    <option value={{$orden->dato22}}>{{$orden->dato22}}</option>
                                                    <option value="">{{__('--')}}</option>
                                                       @foreach ($lab as $parametro)
                                                           <option value="{{$parametro['option_value']}}">{{$parametro['option_value']}}</option>                                                    
                                                       @endforeach                                               
                               ...
                               <div class="col-xl-2 col-md-2 col-sm-2 col-4 bordes" > <!-- Nro-->
                                   <table class="table table-bordered altoFila" >
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="nro" class="form-control" placeholder="" value="{{$orden->dato11}}">    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="nroi" class="form-control" placeholder="" value="{{$orden->dato23}}">
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                                           ...
                                           <th scope="row" class="table-secondary ">
                                               <div class="form-group">
                                                   <select class="form-control" id="bisel" type="text" name="bisel" placeholder="--" value=""  >
                                                    <option value={{$orden->dato12}}>{{$orden->dato12}}</option>
                                                    <option value="">{{__('--')}}</option>
                                           ...
                                           <th scope="row" class="table-light">
                                               <div class="form-group">
                                                   <select class="form-control" id="biseli" type="text" name="biseli" placeholder="--" value=""  >
                                                    <option value={{$orden->dato24}}>{{$orden->dato24}}</option>
                                                    <option value="">{{__('--')}}</option>
                                                       @foreach ($bisel as $parametro)
                                                           <option value="{{$parametro['option_value']}}">{{$parametro['option_value']}}</option>                                                    
                                                       @endforeach                                               
                               ...
                               <div class="col-xl-2 col-md-2 col-sm-2 col-4 bordes"> <!-- Lote-->
                                   <table class="table table-bordered altoFila">
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-secondary ">
                                               <input type="text" name="lote" class="form-control" placeholder="" value="{{$orden->dato13}}">    
                                           </th>
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-light">
                                               <input type="text" name="lotei" class="form-control" placeholder="" value="{{$orden->dato25}}">    
                                           </th>
                                         </tr>                                          
                                       </tbody>
                                   </table>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-info altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="tipol" name="tipol"  class="form-control" placeholder="" value="{{$orden->dato26}}">    
                                               </div>
                                           </th>                                            
                                         </tr>  
                                         <tr>
                                           <th scope="row" class="table-primary altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="tratamientol" name="tratamientol"  class="form-control" placeholder="" value="{{$orden->dato29}}">    
                                               </div>
                                           </th>
                                         </tr>                                         
                                       </tbody>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-info altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="claseProgresivol" name="claseProgresivol"  class="form-control" placeholder="" value="{{$orden->dato27}}">    
                                               </div>
                                           </th>                                            
                                         </tr>
                                         <tr>
                                           <th scope="row" class="table-primary altotexto">
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="materiall" name="materiall"  class="form-control" placeholder="" value="{{$orden->dato31}}">    
                                               </div>
                                           </th> 
                                         </tr>                                         
                                       </tbody>
                                       ...
                                       <tbody>
                                           ...
                                           <th scope="row" class="table-info altotexto" style="height: 7.7rem">
                                               ...
                                               <div class="form-group">
                                                   <select class="form-control" id="colorLtel" type="text" name="colorLtel" placeholder="--" value=""  >
                                                    <option value={{$orden->dato30}}>{{$orden->dato30}}</option>
                                                    <option value="">{{__('--')}}</option>
                                         ...
                                         <tr>
                                           <th scope="row" class="table-warning altotexto" style="height: 7.9rem">
                                               ...
                                               <input type="text" name="invimal" class="form-control" placeholder="" value="{{$orden->dato28}}">    
                                           </th>  
                                         </tr>                                         
                                       </tbody>
                                   </table>
                                       ...
                                       <tbody>
                                         <tr>
                                           <th scope="row" class="table-warning altotexto" style="height: 4rem" >
                                               ...
                                               <div class="form-group-addon" >
                                                   <input type="text" id="medicol" name="medicol"  class="form-control" placeholder="" value="{{ utf8_encode($orden->dato32) }}">    
                                               </div>
                                           </th>                                            
                                         </tr>  
                                         <tr>
                   ...
                   <div class="card ">
                       ...
                       <div class="card-body">  
                                       ...
                                       <tbody>
                                           <tr>
                                               <th scope="row" class="table-light altotexto">
                                                   ...
                                                   <div class="form-group">
                                                       <input type="text" name="referenciav" class="form-control" placeholder="" value="{{$orden->dato33}}">                                                   
                                                   </div>
                                               </th>
                                           </tr>
                                       </tbody>
                                               ...
                                               <th scope="row" class="table-secondary altotexto">
                                                   ...
                                                   <div class="form-group">
                                                       <select class="form-control" id="materialv" type="text" name="materialv" placeholder="--" value=""  >                                        
                                                        <option value={{$orden->dato39}}>{{$orden->dato39}}</option>
                                                        <option value="--">{{__('--')}}</option>
                                           ...
                                           <th scope="row" class="table-light altotexto">
                                               ...
                                               <div class="form-group">
                                                   <select class="form-control" id="tipov" type="text" name="tipov" placeholder="--" value=""  >
                                                    <option value={{$orden->dato42}}>{{$orden->dato42}}</option>
                                                    <option value="--">{{__('--')}}</option>
                                           ...
                                           <th scope="row" class="table-secondary altotexto"> 
                                               ...
                                               <div class="form-group">
                                                   <select class="form-control" id="colorMontm" type="text" name="colorMontm" placeholder="--" value=""  >                                        
                                                    <option value={{$orden->dato45}}>{{$orden->dato45}}</option>
                                                    <option value="--">{{__('--')}}</option>
                                       ...
                                       <tbody>
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrmonturav" name="vrmonturav" class="form-control bg-secondary" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrmonturav')" formnovalidate placeholder="" value="" readonly>                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="vrlentev" name="vrlentev" class="form-control bg-secondary"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" onchange="addCommas('vrlentev')" formnovalidate placeholder="" value="" readonly>                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="text" id="totalv" name="totalv" class="form-control bg-secondary" placeholder="" value="" readonly >                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-secondary altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="number" id="abonoinicialv" name="abonoinicialv" class="form-control bg-secondary" onchange="addCommas('abonoinicialv')"  inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" formnovalidate placeholder="" readonly value="">                                                   
                                               </div>
                                         ...
                                         <tr>
                                           ...
                                           <th scope="row" class="table-light altotexto pb-0">
                                               <div class="form-group">
                                                   <input type="text" id="saldov" name="saldov" class="form-control bg-secondary" placeholder="" value="" readonly >                                                   
                                               </div>
                                   ...
                                   <table class="table table-bordered">
                                       ...
                                       <tbody>
                                           <tr  class="table-secondary altotexto">
                                               ...
                                               <th scope="row" class="table-secondary altotexto">                                               
                                                   <div class="form-group">
                                                       <input type="text" name="nroAlmacenm" class="form-control" placeholder="" value="{{$orden->dato51}}">
                                                   </div>
                                               </th>                                           
                                           </tr> 
                                           <tr  class="table-light altotexto">
                                               ...
                                               <th>                                               
                                                   <div class="form-group">
                                                       <input type="text" name="nroRemisionm" class="form-control" placeholder="" value="{{$orden->dato56}}">
                                                   </div>
                                               </th>                                           
                                           </tr> 
                                           <tr>
                                               ...
                                               <th scope="row" class="table-secondary">
                                                   <div class="form-group">
                                                       <input type="text" name="nroFacturav" class="form-control" placeholder="" value="{{$orden->nro_fact}}"> 
                                                   </div>    
                                               </th>
                                             </tr>                                          
                                       </tbody>
                                   ...
                                   <table class="table table-bordered table-sm altoFila">                                        
                                       ...
                                       <tbody>
                                           <tr class="table-light altotexto">
                                               ...
                                               <th>
                                                   <div class="form-group">
                                                       <input type="text" name="horizontalm" class="form-control" placeholder="" value="{{$orden->dato46}}">
                                                   </div>
                                               </th>
                                           </tr>
                                           <tr class="table-secondary altotexto">
                                               ...
                                               <th>
                                                   <div class="form-group">
                                                       <input type="text" name="verticalm" class="form-control" placeholder="" value="{{$orden->dato47}}">
                                                   </div>
                                               </th>
                                           </tr>
                                           <tr class="table-light altotexto">
                                               ...
                                               <th>
                                                   <div class="form-group">
                                                       <input type="text" name="puentem" class="form-control" placeholder="" value="{{$orden->dato48}}">
                                                   </div>
                                               </th>
                                           </tr>
                                           <tr class="table-secondary altotexto">
                                               ...
                                               <th>
                                                   <div class="form-group">
                                                       <input type="text" name="diagonalm" class="form-control" placeholder="" value="{{$orden->dato49}}">
                                                   </div>
                                               </th>
                                           </tr>
                                           <tr class="table-light altotexto">
                                               ...
                                               <th>
                                                   <div class="form-group">
                                                       <input type="text" name="distMecanicam" class="form-control" placeholder="" value="{{$orden->dato50}}">
                                                   </div>    
                                               </th>
                                           </tr>                                        
                                       </tbody>
                                       ...
                                       <tbody>
                                           <tr>
                                                       ...
                                                       <tr class="altotexto table-secondary">
                                                           <th class="p-0">
                                                               <div class="form-group" style="margin-bottom: 2px">
                                                                   <input type="text" name="dVerticeODm" class="form-control" placeholder="" value="{{$orden->dato52}}">
                                                               </div>
                                                           </th>
                                                           <th class="p-0">
                                                               <div class="form-group" style="margin-bottom: 2px">
                                                                   <input type="text" name="dVerticeOIm" class="form-control" placeholder="" value="{{$orden->dato53}}">
                                                               </div>
                                                           </th>
                                                       </tr>                                                    
                                                   </table>
                                             ...
                                             <tr  class="table-light altotexto">
                                               ...
                                               <th>                                               
                                                   <div class="form-group">
                                                       <input type="text" name="panoramicom" class="form-control" placeholder="" value="{{$orden->dato54}}">
                                                   </div>
                                               </th>                                           
                                             </tr>
                                             <tr  class="table-secondary altotexto">
                                               ...
                                               <th class="table-secondary">                                               
                                                   <div class="form-group">
                                                       <input type="text" name="pantoscopicom" class="form-control" placeholder="" value="{{$orden->dato55}}">
                                                   </div>
                                               </th>                                           
                                             </tr>
                                             <tr  class="table-light altotexto">
                                               ...
                                               <th>                                               
                                                   <div class="form-group">
                                                       <input type="text" name="curvaBase" class="form-control" placeholder="" value="{{$orden->curva_base}}">
                                                   </div>
                                               </th>                                           
                                             </tr>                                        
                                       </tbody>
                           ...
                           <div class="row" style="display: contents">
                                <label class="w-75" ><b>{{ __('Estado de La Orden') }}</b></label>
                                <div class="col-12 px-1 px-md-5" style="max-height: 8rem">
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estadoOrden" id="inlineRadio1" value="CUARENTENA" 
                                    @if($orden->dato59 == 'CUARENTENA') checked @endif>
                                    <label class="form-check-label" style="padding-left: 0px" for="inlineRadio1">{{ __('Cuarentena') }}</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estadoOrden" id="inlineRadio2" value="SEPARADO"
                                    @if($orden->dato59 == 'SEPARADO') checked @endif>
                                    <label class="form-check-label" style="padding-left: 0px" for="inlineRadio2">{{ __('Separado') }}</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estadoOrden" id="inlineRadio3" value="PEDIDO_LABORATORIO"
                                    @if($orden->dato59 == 'PEDIDO_LABORATORIO') checked @endif>
                                    <label class="form-check-label" style="padding-left: 0px" for="inlineRadio3">{{ __('Pedido Laboratorio') }}</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estadoOrden" id="inlineRadio4" value="CORTE Y DISENO"
                                    @if($orden->dato59 == 'CORTE Y DISENO') checked @endif>
                                    <label class="form-check-label" style="padding-left: 0px" for="inlineRadio4">{{ __('Corte y Diseño') }}</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estadoOrden" id="inlineRadio5" value="PRODUCTO TERMINADO"
                                    @if($orden->dato59 == 'PRODUCTO TERMINADO') checked @endif>
                                    <label class="form-check-label" style="padding-left: 0px" for="inlineRadio5">{{ __('Producto Terminado') }}</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="estadoOrden" id="inlineRadio6" value="TRABAJO ENTREGA"
                                    @if($orden->dato59 == 'TRABAJO ENTREGA') checked @endif>
                                    <label class="form-check-label" style="padding-left: 0px" for="inlineRadio6">{{ __('Trabajo Entrega') }}</label>
                                  </div>                                  
                                </div>
                           </div>
                           <div class="row" style="display: contents">{{-- Servioptica --}}
                           
                                <div class="col-12 px-1 px-md-5">
                                    <table class="table table-bordered altotexto">
                                        <thead>
                                            <tr class="table-light altotexto">
                                                <th>
                                                    <div class="form-group h-50" style="margin-bottom: 2px">
                                                        <label class="w-75" style="display: contents; text-transform: capitalize" ><b>{{ __('Montura') }}</b></label>
                                                    </div>
                                                </th>
                                                <th>
                                                    <div class="form-group altotexto" style="margin-bottom: 2px">
                                                        <input type="text" name="SOmontura" class="form-control" placeholder="" value="{{$servioptica->so_montura}}">
                                                    </div>
                                                </th>
                                            </tr>                                          
                                        </thead>
                                        <tbody>
                                            <tr class="table-light altotexto">
                                                <th>
                                                    <label class="w-75" ><b>{{ __('Estado') }}</b></label>
                                                </th>
                                                <th class="p-0">
                                                    <table class="m-0 altotexto">
                                                        <tr class="table-secondary altotexto">
                                                            <th>
                                                                <div>
                                                                    <label class="w-75" ><b>{{ __('Nueva') }}</b></label>
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="SOnueva" class="form-control" placeholder="" value="{{$servioptica->so_nueva}}">
                                                                </div>
                                                            </th>
                                                            <th>
                                                                <div>
                                                                    <label class="w-75" ><b>{{ __('Usada') }}</b></label>
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="SOusada" class="form-control" placeholder="" value="{{$servioptica->so_usada}}">
                                                                </div>
                                                            </th>
                                                            <th>
                                                                <div>
                                                                    <label class="w-75" ><b>{{ __('Ref') }}</b></label>
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="SOref" class="form-control" placeholder="" value="{{$servioptica->so_ref}}">
                                                                </div>
                                                            </th>
                                                        </tr>
                                                        <tr class="table-light altotexto">
                                                            <th>
                                                                <div>
                                                                    <label class="w-75" ><b>{{ __('Rayada') }}</b></label>
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="SOrayada" class="form-control" placeholder="" value="{{$servioptica->so_rayada}}">
                                                                </div>
                                                            </th>
                                                            <th>
                                                                <div>
                                                                    <label class="w-75" ><b>{{ __('Pelada') }}</b></label>
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="SOpelada" class="form-control" placeholder="" value="{{$servioptica->so_pelada}}">
                                                                </div>
                                                            </th>
                                                            <th>
                                                                <div>
                                                                    <label class="w-75" ><b>{{ __('Otro') }}</b></label>
                                                                </div>
                                                                <div>
                                                                    <input type="text" name="SOotro" class="form-control" placeholder="" value="{{$servioptica->so_otro}}">
                                                                </div>
                                                            </th>
                                                        </tr>
                                                    </table>
                           ...
                           <div class="row" style="display: contents">
                               <div class="col-12 px-1 px-md-5" style="max-height: 8rem">
                                   ...
                                   <div class="form-group observ">
                                       <textarea class="form-control" name="observaciones" aria-label="With textarea">{{$orden->dato57}}</textarea>
                                   </div>                                        
                               </div>
                               <div class="col-12 px-1 px-md-5" style="max-height: 8rem">
                               ...
                               <div class="col-12 px-1 px-md-5" style="max-height: 8rem">
                                    ...
                                    <br>
                                    <div class="form-group observ">
                                        <textarea class="form-control" name="observacionlab" aria-label="With textarea">{{$orden->obs_lab}}</textarea>
                                    </div>                                        
                                </div>
                           </div>                                                              
                       </div>
                       <div class="card-footer ">
                           <div class="row">
                               <div class="col-md-12 text-center">
                                   <button type="submit" class="btn btn-info btn-round">{{ __('Actualizar Orden') }}</button>
                               </div>
                           </div>
                       </div>
                   </div>
