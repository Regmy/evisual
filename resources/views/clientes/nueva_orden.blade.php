...
@section('content')
            ...
            <div class="col-md-12 text-center">
                <div class="card">                      
                    <div class="card-header">
                        <h5 class="title">{{ __('Nueva Orden') }}</h5>                                                         
                    </div>
                    <div class="card-body">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">                                
                            <div class="col-6 col-md-2 align-middle pl-1  " style="font-size: 1em" >
                                ...
                                <br>{{ date('m/d/Y') }}
                                <br><label class="pt-2"><b>{{ __('Asesor:') }}</b> <b class="text-dark">{{ auth()->user()->nombre }}</b></label>
                            </div>                                
                            <div class="col-6 col-md-2 align-middle pl-1" style="font-size: 0.85em">
                                <label class=""><b>{{ __('Fecha Entrega') }} </b></label>
                                <br><input id="fechaEntrega2" style="width: 90%" type="date" name="fechaE" onchange="changeFecha()"> 
                                <br><label class="pt-1"><b>{{ __('Hora Entrega') }}</b></label>
                                <br><input id="horaEntrega2" type="time" name="horaE" value="12:00" onchange="changeHora()">                       
                            </div>                            
                    ...
                    <div class="card-footer ">
                        <form action="{{ route('ordenes.create', $cliente->id) }}" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="_method" value="GET">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <div style="display: block">
                                <input style="width: 30%; display: inline" type="number" name="idHistoriaOptisoftSearch"  class="form-control" placeholder ="Ingresar N° de la Historia a Importar" value="">                                
                            </div>
                            <br>
                            <button type="submit" class="btn btn-info btn-round">{{ __('Importar Optisfot') }}</button>                                
                        </form>
                    </div>
                    <div class="col-12">
                        @if (session('status'))
                ...
                <form class="col-md-12" action="{{ route('ordenes.store') }}" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="estadoOrden" value="CUARENTENA">
                    <input type="hidden" name="idCliente" value="{{$cliente->id}}">
                    <input type="hidden" id="fechaEntrega" name="fechaEntrega"x>
                    <input type="hidden" id="horaEntrega" name="horaEntrega"x>
                                          ...
                                          <tr>
                                            <th scope="row" class="table-secondary alinear" >
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id='esfera' name="esfera"  class="form-control" placeholder="" value="{{$refractive_re->rx_sphere}}" >    
                                                </div>
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light alinear">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="esferai" name="esferai"  class="form-control" placeholder="" value="{{$refractive_le->rx_sphere}}" >    
                                                </div> 
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary alinear ">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="cilindro" name="cilindro"  class="form-control" placeholder="" value="{{$refractive_re->rx_cylinder}}" >    
                                                </div>  
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light alinear">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="cilindroi" name="cilindroi"  class="form-control" placeholder="" value="{{$refractive_le->rx_cylinder}}" >    
                                                </div>  
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary ">
                                                <input type="text" name="eje"  class="form-control" placeholder="" value="{{$refractive_re->rx_axis}}" >    
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light">
                                                <input type="text" name="ejei"  class="form-control" placeholder="" value="{{$refractive_le->rx_axis}}" >    
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary  ">
                                                <div class="form-group" >
                                                    <select class="form-control" id="adicion" type="text" name="adicion" placeholder="--" value="{{$refractive_re->rx_add}}"  >
                                                    <option value={{$refractive_re->rx_add}}>{{$refractive_re->rx_add}}</option>
                                          ...
                                          <tr>
                                            <th scope="row" class="table-light ">
                                                <div class="form-group " >
                                                    <select class="form-control" id="adicioni" type="text" name="adicioni" placeholder="--" value="{{$refractive_le->rx_add}}"  >
                                                    <option value={{$refractive_le->rx_add}}>{{$refractive_le->rx_add}}</option>
                                                        @foreach ($adicion as $parametro)
                                                            <option value="{{$parametro['option_value']}}">{{$parametro['option_value']}}</option>                                                    
                                                        @endforeach                                               
                                                    </select>                                   
                                ...
                                <div class="col-xl-1 col-md-2 col-sm-2 col-6 bordes" > <!-- D.N.P-->
                                    <table class="table table-bordered altoFila"  >
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary ">
                                                <input type="text" name="dnp" class="form-control" placeholder="" value="{{$refractive_re->rx_np}}" >    
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light">
                                                <input type="text" name="dnpi" class="form-control" placeholder="" value="{{$refractive_le->rx_np}}" >    
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-xl-1 col-md-2 col-sm-2 col-6 bordes" > <!-- Altura-->
                                    <table class="table table-bordered altoFila" >
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary ">
                                                <input type="text" name="altura" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light">
                                                <input type="text" name="alturai" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-xl-2 col-md-2 col-sm-2 col-6 bordes" > <!-- Prisma-->
                                    <table class="table table-bordered altoFila" >
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary ">
                                                <input type="text" name="prisma"  class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light">
                                                <input type="text" name="prismai" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-xl-2 col-md-2 col-sm-2 col-4 bordes" > <!-- Nro-->
                                    <table class="table table-bordered altoFila" >
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary ">
                                                <input type="text" name="nro" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light">
                                                <input type="text" name="nroi" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-xl-2 col-md-2 col-sm-2 col-4 bordes"> <!-- Lote-->
                                    <table class="table table-bordered altoFila">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-secondary ">
                                                <input type="text" name="lote" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-light">
                                                <input type="text" name="lotei" class="form-control" placeholder="" value="" >    
                                            </th>
                                          </tr>                                          
                                        </tbody>
                                    </table>
                            ...
                            <div class="row ">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-light altotexto">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="tipol" name="tipol"  class="form-control" placeholder="" value="{{$refractive->lens_type}}" >    
                                                </div>
                                            </th>                                            
                                          </tr>  
                                          <tr>
                                            <th scope="row" class="table-secondary altotexto">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="tratamientol" name="tratamientol"  class="form-control" placeholder="" value="{{$refractive->treatment}}" >    
                                                </div>
                                            </th>
                                          </tr>                                         
                                        </tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-light altotexto">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="claseProgresivol" name="claseProgresivol"  class="form-control" placeholder="" value="" >    
                                                </div>
                                            </th>                                            
                                          </tr>
                                          <tr>
                                            <th scope="row" class="table-secondary altotexto">
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="materiall" name="materiall"  class="form-control" placeholder="" value="{{$refractive->detail}}" >    
                                                </div>
                                            </th> 
                                          </tr>                                         
                                        </tbody>
                                ...
                                <div class="col-12 col-sm-6 col-md-3 bordes">
                                    <table class="table table-bordered altoFila">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-light altotexto" style="height: 7.7rem">
                                                <label class="w-75" ><b>{{ __('Color LTE') }}</b></label>
                                                <div class="form-group">
                                                    <select class="form-control" id="colorLtel" type="text" name="colorLtel" placeholder="--" value="{{$refractive->color}}">
                                                    <option value="">{{__('--')}}</option>
                                          ...
                                          <tr>
                                            <th scope="row" class="table-secondary altotexto" style="height: 7.9rem">
                                                <label class="w-75" ><b>{{ __('Invima') }}</b></label>
                                                <input type="text" name="invimal" class="form-control" placeholder="" value="" >    
                                            </th>  
                                          </tr>                                         
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-12 col-sm-6 col-md-3 bordes">
                                    <table class="table table-bordered altoFila">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th scope="row" class="table-light altotexto" style="height: 4rem" >
                                                ...
                                                <div class="form-group-addon" >
                                                    <input type="text" id="medicol" name="medicol"  class="form-control" placeholder="" value="" >    
                                                </div>
                                            </th>                                            
                                          </tr>  
                                          <tr>
                    ...
                    <div class="card ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row" class="table-light altotexto">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="referenciav" class="form-control" placeholder="" value="" >                                                   
                                                    </div>
                                                </th>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr  class="table-secondary altotexto">
                                                ...
                                                <th scope="row" class="table-secondary altotexto">                                               
                                                    <div class="form-group">
                                                        <input type="text" name="nroAlmacenm" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>                                           
                                            </tr> 
                                            <tr  class="table-light altotexto">
                                                ...
                                                <th>                                               
                                                    <div class="form-group">
                                                        <input type="text" name="nroRemisionm" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>                                           
                                            </tr> 
                                            <tr>
                                                ...
                                                <th scope="row" class="table-secondary">
                                                    <div class="form-group">
                                                        <input type="text" name="nroFacturav" class="form-control" placeholder="" value="" >                                                   
                                                    </div>    
                                                </th>
                                              </tr>                                          
                                        </tbody>
                                    ...
                                    <table class="table table-bordered table-sm altoFila">                                        
                                        ...
                                        <tbody>
                                            <tr class="table-light altotexto">
                                                ...
                                                <th>
                                                    <div class="form-group">
                                                        <input type="text" name="horizontalm" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>
                                            </tr>
                                            <tr class="table-secondary altotexto">
                                                ...
                                                <th>
                                                    <div class="form-group">
                                                        <input type="text" name="verticalm" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>
                                            </tr>
                                            <tr class="table-light altotexto">
                                                ...
                                                <th>
                                                    <div class="form-group">
                                                        <input type="text" name="puentem" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>
                                            </tr>
                                            <tr class="table-secondary altotexto">
                                                ...
                                                <th>
                                                    <div class="form-group">
                                                        <input type="text" name="diagonalm" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>
                                            </tr>
                                            <tr class="table-light altotexto">
                                                ...
                                                <th>
                                                    <div class="form-group">
                                                        <input type="text" name="distMecanicam" class="form-control" placeholder="" value="" >
                                                    </div>    
                                                </th>
                                            </tr>                                        
                                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr class="altotexto table-secondary">
                                                            <th class="p-0">
                                                                <div class="form-group" style="margin-bottom: 2px">
                                                                    <input type="text" name="dVerticeODm" class="form-control" placeholder="" value="" >
                                                                </div>
                                                            </th>
                                                            <th class="p-0">
                                                                <div class="form-group" style="margin-bottom: 2px">
                                                                    <input type="text" name="dVerticeOIm" class="form-control" placeholder="" value="" >
                                                                </div>
                                                            </th>
                                                        </tr>                                                    
                                                    </table>
                                              ...
                                              <tr  class="table-light altotexto">
                                                ...
                                                <th>                                               
                                                    <div class="form-group">
                                                        <input type="text" name="panoramicom" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>                                           
                                              </tr>
                                              <tr  class="table-secondary altotexto">
                                                ...
                                                <th class="table-secondary">                                               
                                                    <div class="form-group">
                                                        <input type="text" name="pantoscopicom" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>                                           
                                              </tr>
                                              <tr  class="table-light altotexto">
                                                ...
                                                <th>                                               
                                                    <div class="form-group">
                                                        <input type="text" name="curva_base" class="form-control" placeholder="" value="" >
                                                    </div>
                                                </th>                                           
                                              </tr>                                        
                                        </tbody>
                        ...
                        <div class="card-footer ">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Crear Orden') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function changeHora() {
            document.getElementById("horaEntrega").value = document.getElementById("horaEntrega2").value;
        }
        function changeFecha() {
            document.getElementById("fechaEntrega").value = document.getElementById("fechaEntrega2").value;
        }
    </script>
@endsection