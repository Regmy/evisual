                    ...
                    <div class="card bg-secondary shadow">
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Agregar Sede') }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.storeFacturaRango') }}" autocomplete="off"  accept-charset="UTF-8" enctype="multipart/form-data"> 
                                <input type="hidden" name="_method" value="PUT">                               
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">                            
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('sede') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-producto"> {{ __('Nombre de la Sede') }}</label><br>
                                    <input type="text" name="sede" id="input-sede" class="form-control form-control-alternative{{ $errors->has('sede') ? ' is-invalid' : '' }}" placeholder="" value="{{old('sede')}}" >                                        
                                        @if ($errors->has('sede'))
                                    ...
                                    <div class="form-group{{ $errors->has('inicio') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="inicio" id="input-inicio" class="form-control form-control-alternative{{ $errors->has('inicio') ? ' is-invalid' : '' }}" placeholder="" value="{{old('inicio')}}">                                        
                                    ...
                                    <div class="form-group{{ $errors->has('fin') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="fin" id="input-fin" class="form-control form-control-alternative{{ $errors->has('fin') ? ' is-invalid' : '' }}" placeholder="" value="{{old('fin')}}" >                                        
                                        @if ($errors->has('fin'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group{{ $errors->has('leyenda') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="texto" id="input-leyenda" aria-label="With textarea" class="form-control form-control-alternative{{ $errors->has('leyenda') ? ' is-invalid' : '' }}">{{old('texto')}}</textarea>                                        
                                    ...
                                    <div class="form-group{{ $errors->has('prefijo') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="prefijo" id="input-prefijo" class="form-control form-control-alternative{{ $errors->has('prefijo') ? ' is-invalid' : '' }}" placeholder="" value="{{old('prefijo')}}">                                        
                                    ...
                                    <div class="form-group{{ $errors->has('resolucion') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="resolucion" id="input-resolucion" aria-label="With textarea" class="form-control form-control-alternative{{ $errors->has('resolucion') ? ' is-invalid' : '' }}" >{{old('resolucion')}}</textarea>                                        
                                    ...
                                    <div class="form-group{{ $errors->has('iva') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="iva" id="input-iva" class="form-control form-control-alternative{{ $errors->has('iva') ? ' is-invalid' : '' }}" placeholder='' value="{{old('iva')}}" >                                        
                                        @if ($errors->has('iva'))
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group{{ $errors->has('rangoInicio') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="rangoInicio" id="input-rangoInicio" class="form-control form-control-alternative{{ $errors->has('rangoInicio') ? ' is-invalid' : '' }}" placeholder="" value="{{old('rangoInicio')}}" >                                        
                                    ...
                                    <div class="form-group{{ $errors->has('rangoFin') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" name="rangoFin" id="input-rangoFin" class="form-control form-control-alternative{{ $errors->has('rangoFin') ? ' is-invalid' : '' }}" placeholder="" value="{{old('rangoFin')}}" >                                        
                                    ...
                                    <div class="form-group{{ $errors->has('textoDevolucion') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="textoDevolucion" id="input-textoDevolucion" aria-label="With textarea" class="form-control form-control-alternative{{ $errors->has('textoDevolucion') ? ' is-invalid' : '' }}">{{old('textoDevolucion')}}</textarea>                                        
                                    ...
                                    <div class="form-group{{ $errors->has('textoHorarios') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea name="textoHorarios" id="input-textoHorarios" aria-label="With textarea" class="form-control form-control-alternative{{ $errors->has('textoHorarios') ? ' is-invalid' : '' }}">{{old('textoHorarios')}}</textarea>                                        
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                          <span class="input-group-text" id="inputGroupFile02" style="padding: 0px;">
                                            <label class="form-control-label" for="input-producto" style="padding-right: 2rem; font-size: 0.7571em"> {{ __('Imagen Datos') }}</label>                                          
                                        </span>
                                        </div>
                                        <div class="custom-file">
